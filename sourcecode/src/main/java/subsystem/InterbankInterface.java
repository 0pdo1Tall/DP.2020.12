...
public interface InterbankInterface {
	 ...
	 */
    PaymentTransaction payOrder(PaymentMethod card, int amount, String contents, PaymentMethodFactory paymentMethodFactory)
	 ...
	 *                               something goes wrong
	 */
    PaymentTransaction refund(PaymentMethod card, int amount, String contents)
			throws PaymentException, UnrecognizedException;
